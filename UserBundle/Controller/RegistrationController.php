...
class RegistrationController extends BaseController
{
    ...
    public function registerAction(Request $request)
    {
        ...
        $form->setData($user);
        $form->add('email', LegacyFormHelper::getType('Symfony\Component\Form\Extension\Core\Type\EmailType'), array('label' => 'Adresse mail :', 'attr'=>array('class' =>'form-control')))
            ...
            ->add('postcode', TextType::class, array('label' => 'Code postal :', 'attr'=>array('class' =>'form-control')))
            ->add('phone', TextType::class, array('label' => 'Téléphone :', 'attr'=>array('class' =>'form-control')))
            ->add('plainPassword', LegacyFormHelper::getType('Symfony\Component\Form\Extension\Core\Type\RepeatedType'), array(
                'type' => LegacyFormHelper::getType('Symfony\Component\Form\Extension\Core\Type\PasswordType'),                
                'first_options' => array('label' => 'Mot de passe :', 'attr'=>array('class' =>'form-control')),
                'second_options' => array('label' => 'Répétez votre mot de passe :', 'attr'=>array('class' =>'form-control')),
